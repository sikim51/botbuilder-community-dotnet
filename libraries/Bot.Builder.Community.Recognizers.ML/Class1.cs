...
{
    public class MLModelEngine<TData, TPrediction> : IMLModelEngine<TData, TPrediction> where TData : class
                   where TPrediction : class, new()
    {
        private readonly MLContext _mlContext;
        private readonly string _modelFilePathName;
        ...
        public MLModelEngine(string modelFilePathName, int maxObjectsRetained = -1)
        {
            ...
            this._modelFilePathName = modelFilePathName;
        ...
        public void BuildAndTrainModel(string DataSetLocation)
        {

            // STEP 1: Common data loading configuration
            var trainingDataView = _mlContext.Data.LoadFromTextFile<TData>(DataSetLocation, hasHeader: true, separatorChar: '\t', allowSparse: false);

            // STEP 2: Common data process configuration with pipeline data transformations
            var dataProcessPipeline = _mlContext.Transforms.Conversion.MapValueToKey(outputColumnName: "Label", inputColumnName: "Name")
                            .Append(_mlContext.Transforms.Text.FeaturizeText(outputColumnName: "Features", inputColumnName: "Utterance"))
            ...
            trainer = _mlContext.MulticlassClassification.Trainers.SdcaMaximumEntropy("Label", "Features");
            ...
            _mlContext.Model.Save(trainedModel, trainingDataView.Schema, this._modelFilePathName);

            this._mlModel = trainedModel;
        }
    }
}